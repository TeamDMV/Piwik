...
class VisitCount extends VisitDimension
{
    ...
    {
        return Piwik::translate('PiwikNotifiy_VisitCount');
    }
    ...
    protected function configureSegments()
    {
        ...
        $segment->setName('PiwikNotifiy_VisitCount');
